...
Docker utilizando o compose, arquivo de configuração com variáveis de ambiente, criando um container nginx 1.19.0 e um container php 7.4.2 ligados através de um link e criando um container mysql 5.7.22
...
2. Entre na pasta da aplicação e copie o arquivo env-example para .env.
